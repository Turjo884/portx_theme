      ...
      <div class="footer-area theme-background pt-120 pb-80 p-relative fix">
         ...
         <div class="container">
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="tp-footer__widget  tp-footer-col-1 mb-40  wow fadeInUp  " data-wow-duration=".9s"
                     ...
                     <a href="index.html" class="tp-footer__widget-logo">
                        <img src="<?php echo get_template_directory_uri();?>/assets/img/logo/footer-logo.png" alt="">
                     </a>
                     ...
                     <div class="tp-footer__contact-info tp-footer__icon-space">
                        <ul>
                           ...
                           <li>
                              ...
                              <a href="mailto:contact@info.com">portxinfocompany@gmail.com</a>
                           </li>
                           <li>
                              <span>
                                 <i class="flaticon-location"></i>
                              </span>
                              <a href="https://www.google.com/maps/@41.6758525,-86.2531698,18.17z" target="_blank">27
                                 Division St, Sans fransisco , USA </a>
                           </li>
                        </ul>
                     </div>
                  </div>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="tp-footer__widget tp-footer-col-2  mb-40 fix wow fadeInUp  "
                     ...
                     <div class="tp-footer__fw-insta">
                        <ul>
                           <li><a href="#"><i class="fa-brands fa-linkedin-in"></i> <img
                                    src="<?php echo get_template_directory_uri();?>/assets/img/instagram/instagram-1.jpg" alt=""></a></li>
                           <li><a href="#"><i class="fa-brands fa-linkedin-in"></i><img
                                    src="<?php echo get_template_directory_uri();?>/assets/img/instagram/instagram-2.jpg" alt=""></a></li>
                           <li><a href="#"><i class="fa-brands fa-linkedin-in"></i> <img
                                    src="<?php echo get_template_directory_uri();?>/assets/img/instagram/instagram-3.jpg" alt=""></a></li>
                           <li><a href="#"><i class="fa-brands fa-linkedin-in"></i><img
                                    src="<?php echo get_template_directory_uri();?>/assets/img/instagram/instagram-4.jpg" alt=""></a></li>
                           <li><a href="#"><i class="fa-brands fa-linkedin-in"></i><img
                                    src="<?php echo get_template_directory_uri();?>/assets/img/instagram/instagram-5.jpg" alt=""></a></li>
                           <li><a href="#"><i class="fa-brands fa-linkedin-in"></i><img
                                    src="<?php echo get_template_directory_uri();?>/assets/img/instagram/instagram-6.jpg" alt=""></a></li>
                        </ul>
                     </div>
                  </div>
               </div>
